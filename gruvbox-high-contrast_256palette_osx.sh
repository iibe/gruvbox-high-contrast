...
if [ "${TERM%%-*}" = "screen" ]; then
  if [ -n "$TMUX" ]; then
    printf "\033Ptmux;\033\033]4;236;rgb:00/00/00\007\033\\"
    printf "\033Ptmux;\033\033]4;234;rgb:00/00/00\007\033\\"

    printf "\033Ptmux;\033\033]4;235;rgb:00/00/00\007\033\\"
    ...
    printf "\033P\033]4;236;rgb:00/00/00\007\033\\"
    printf "\033P\033]4;234;rgb:00/00/00\007\033\\"

    printf "\033P\033]4;235;rgb:00/00/00\007\033\\"
  ...
  printf "\033]4;236;rgb:00/00/00\033\\"
  printf "\033]4;234;rgb:00/00/00\033\\"

  printf "\033]4;235;rgb:00/00/00\033\\"
