...
if [ "${TERM%%-*}" = "screen" ]; then
  if [ -n "$TMUX" ]; then
    printf "\033Ptmux;\033\033]4;236;rgb:00/00/00\007\033\\" ## 00-00-00
    printf "\033Ptmux;\033\033]4;234;rgb:07/07/07\007\033\\" ## 07-07-07

    printf "\033Ptmux;\033\033]4;235;rgb:0f/0f/0f\007\033\\" ## 15-15-15
    ...
    printf "\033P\033]4;236;rgb:00/00/00\007\033\\" ## 00-00-00
    printf "\033P\033]4;234;rgb:07/07/07\007\033\\" ## 07-07-07

    printf "\033P\033]4;235;rgb:0f/0f/0f\007\033\\" ## 15-15-15
  ...
  printf "\033]4;236;rgb:00/00/00\033\\" # 00-00-00
  printf "\033]4;234;rgb:07/07/07\033\\" # 07-07-07

  printf "\033]4;235;rgb:0f/0f/0f\033\\" # 15-15-15
